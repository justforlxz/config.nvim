return function()
	...
	efmls.setup({
		...
		vue = { formatter = eslint },
		typescript = { formatter = eslint, linter = eslint },
		javascript = { formatter = eslint, linter = eslint },
		typescriptreact = { formatter = eslint, linter = eslint },
		javascriptreact = { formatter = eslint, linter = eslint },
