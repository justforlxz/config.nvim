...
local plug_map = {
	...
	["n|<leader>lf"] = map_cr("LspFormat file"):with_noremap():with_silent():with_nowait():with_desc("lsp: Format"),
	["v|<leader>lf"] = map_cu("LspFormat range"):with_noremap():with_silent():with_desc("lsp: Format"),
	["n|<C-/>"] = map_cr("CommentToggle"):with_noremap():with_silent():with_nowait():with_desc("Toggle comment"),
	["v|<C-/>"] = map_cu("CommentToggle"):with_noremap():with_silent():with_nowait():with_desc("Toggle comment"),
